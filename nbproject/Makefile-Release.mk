...
${OBJECTDIR}/MQTT/Client/MQTTClient.o: MQTT/Client/MQTTClient.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Client/MQTTClient.o MQTT/Client/MQTTClient.c

${OBJECTDIR}/MQTT/Client/MQTTLinux.o: MQTT/Client/MQTTLinux.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Client
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Client/MQTTLinux.o MQTT/Client/MQTTLinux.c

${OBJECTDIR}/MQTT/Packet/MQTTConnectClient.o: MQTT/Packet/MQTTConnectClient.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTConnectClient.o MQTT/Packet/MQTTConnectClient.c

${OBJECTDIR}/MQTT/Packet/MQTTConnectServer.o: MQTT/Packet/MQTTConnectServer.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTConnectServer.o MQTT/Packet/MQTTConnectServer.c

${OBJECTDIR}/MQTT/Packet/MQTTDeserializePublish.o: MQTT/Packet/MQTTDeserializePublish.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTDeserializePublish.o MQTT/Packet/MQTTDeserializePublish.c

${OBJECTDIR}/MQTT/Packet/MQTTFormat.o: MQTT/Packet/MQTTFormat.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTFormat.o MQTT/Packet/MQTTFormat.c

${OBJECTDIR}/MQTT/Packet/MQTTPacket.o: MQTT/Packet/MQTTPacket.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTPacket.o MQTT/Packet/MQTTPacket.c

${OBJECTDIR}/MQTT/Packet/MQTTSerializePublish.o: MQTT/Packet/MQTTSerializePublish.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTSerializePublish.o MQTT/Packet/MQTTSerializePublish.c

${OBJECTDIR}/MQTT/Packet/MQTTSubscribeClient.o: MQTT/Packet/MQTTSubscribeClient.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTSubscribeClient.o MQTT/Packet/MQTTSubscribeClient.c

${OBJECTDIR}/MQTT/Packet/MQTTSubscribeServer.o: MQTT/Packet/MQTTSubscribeServer.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTSubscribeServer.o MQTT/Packet/MQTTSubscribeServer.c

${OBJECTDIR}/MQTT/Packet/MQTTUnsubscribeClient.o: MQTT/Packet/MQTTUnsubscribeClient.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTUnsubscribeClient.o MQTT/Packet/MQTTUnsubscribeClient.c

${OBJECTDIR}/MQTT/Packet/MQTTUnsubscribeServer.o: MQTT/Packet/MQTTUnsubscribeServer.c
	${MKDIR} -p ${OBJECTDIR}/MQTT/Packet
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IMQTT/Packet -IMQTT/Client -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MQTT/Packet/MQTTUnsubscribeServer.o MQTT/Packet/MQTTUnsubscribeServer.c
